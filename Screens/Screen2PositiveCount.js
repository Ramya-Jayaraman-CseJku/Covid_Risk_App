...
export default function getPositiveCasesCountAPI() {
  ...
  useEffect(() => {
    if (loading) {
      async function getDistrictData() {
        await fetch(
          `https://eb79-193-171-38-41.ngrok.io/api/positivecasesbydistrict/?districtname=${selectedDistrict}&year=${selectedYear}&interval=${selectedInterval}`,
        )
  ...
  const sampleurl = `https://e6fc-193-171-38-41.ngrok.io/api/positivecasesbydistrict/?districtname=${selectedDistrict}&year=${selectedYear}&interval=${selectedInterval}`;
